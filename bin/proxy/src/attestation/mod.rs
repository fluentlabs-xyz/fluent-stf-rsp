...
mod tests {
    ...
    //     let guest_input = prepare::prepare_guest_input(ATTESTATION_BYTES,
    // ROOT_CERT_DER).unwrap();
    ...
    //     assert_eq!(verified_addr, expected_addr, "verified address does not match
    // public_key.hex");
